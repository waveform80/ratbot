...
It's perfectly fine to re-use this definition in the ratbot application,
though.
...
group_permission_table = Table('group_permissions', metadata,
    Column('group_name', Unicode(128), ForeignKey('groups.group_name',
        onupdate="CASCADE", ondelete="CASCADE"), primary_key=True),
    Column('permission_name', Unicode(128), ForeignKey('permissions.permission_name',
        onupdate="CASCADE", ondelete="CASCADE"), primary_key=True)
)
...
user_group_table = Table('user_groups', metadata,
    Column('user_name', Unicode(128), ForeignKey('users.user_name',
        onupdate="CASCADE", ondelete="CASCADE"), primary_key=True),
    Column('group_name', Unicode(128), ForeignKey('groups.group_name',
        onupdate="CASCADE", ondelete="CASCADE"), primary_key=True)
)
